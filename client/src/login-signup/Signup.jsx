    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(SIGNUP_URL,
                JSON.stringify({ customer_fname : firstName, customer_lname: lastName, customer_email: email, password: pwd,  phone_number: contact }),
                {
            ...
            {success ? (
                ...
                <section>
                    ...
                    <label htmlFor="email">
                        ...
                        />
                        <p id="emailnote" className={contactFocus && !validEmail ? "instructions" : "offscreen"}>
